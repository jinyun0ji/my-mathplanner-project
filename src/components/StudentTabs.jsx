...
export const DashboardTab = ({ student, myClasses, attendanceLogs, clinicLogs, homeworkStats, notices, setActiveTab, externalSchedules, isParent = false }) => {
            ...
            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 flex justify-between items-center relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">
                        {isParent ? `안녕하세요, ${student.name} 학부모님!` : `반가워요, ${student.name}님! 👋`}
                    </h2>
                </div>
            </div>
...
export const MenuTab = ({ student, onUpdateStudent, onLogout, videoBookmarks, lessonLogs, onLinkToMemo, notices, setActiveTab, isParent = false }) => {
    // ... MenuTab logic ...
